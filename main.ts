 ...
 * 計算長方形面積 & 回傳 
 */
//% blockId="ReturnAreaOfRectangle" block="Return Area of Rectangle = length %length | x  width %width"
//% blockGap=5 weight=0
 ...
 * 計算三角形面積 & 回傳 
 */
//% blockId="ReturnAreaOfTriangle" block="Return Area of Triangle = bottom %bottom | x  high %high | /2"
//% blockGap=5 weight=1
